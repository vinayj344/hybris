...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/johndeerestorefront/electronics/en",
						"https://electronics.local:9002/johndeerestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/johndeerestorefront/electronics/en",
						"https://electronics.local:9002/johndeerestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/johndeerestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/johndeerestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/johndeerestorefront/electronics/en",
						"https://electronics.local:9002/johndeerestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/johndeerestorefront",
						"https://electronics.local:9002/johndeerestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/johndeerestorefront",
						"https://electronics.local:9002/johndeerestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/johndeerestorefront/electronics/en",
						"https://electronics.local:9002/johndeerestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
