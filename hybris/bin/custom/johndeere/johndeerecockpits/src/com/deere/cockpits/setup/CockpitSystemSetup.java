 ...
 */
package com.deere.cockpits.setup;
...
import com.deere.cockpits.constants.JohndeereCockpitsConstants;
 ...
 */
@SystemSetup(extension = JohndeereCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(JohndeereCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(JohndeereCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						JohndeereCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/johndeerecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
