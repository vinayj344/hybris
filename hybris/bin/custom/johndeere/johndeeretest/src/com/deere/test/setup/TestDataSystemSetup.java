...
import com.deere.test.constants.JohndeereTestConstants;
import com.deere.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = JohndeereTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/johndeeretest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/johndeeretest/import/reviews.impex");
				...
				importImpexFile(context, "/johndeeretest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/johndeeretest/import/csquotes.impex");
			}
		}
	}
}
