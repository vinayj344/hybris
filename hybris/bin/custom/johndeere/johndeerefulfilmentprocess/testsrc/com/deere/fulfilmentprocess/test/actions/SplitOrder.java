 ...
 */
package com.deere.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(JohndeereFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(JohndeereFulfilmentProcessConstants.PARENT_PROCESS);
